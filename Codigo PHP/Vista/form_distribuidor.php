  ...
  <center>
    <form action="../Controlador/distribuidorControlador.php?a=modificar" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control-6" placeholder="Ingrese Nombre" name="nombre" value = "<?= $elemento[1]?>" required>
        </div>
        <div class="form-group">
          <label >RUC: </label><br>
          <input type="text" class="form-control-6" placeholder="Ingrese RUC" name="ruc" value = "<?= $elemento[2]?>" required>
        </div>
